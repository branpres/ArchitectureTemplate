...
public static class Create
{
    public class Endpoint : IEndpoint
    {
        ...
        {
            var handler = new Handler(validator, currentUser, templateDbContext);
...
public static class CreateResponseMapper
{
    public static Create.CreateProjectResponse MapToCreateResponse(this Project project)
    {
        return new Create.CreateProjectResponse(
            project.ProjectId,
            project.CompanyId,
            project.ProjectName!,
